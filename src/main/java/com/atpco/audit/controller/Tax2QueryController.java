...
import com.btw.webservice.itax.*;
 ...
 */
@Controller
@RequestMapping(value = "/tax2")
public class Tax2QueryController extends BaseController {
    ...
    public List<Tax> query(Map map) throws Exception{
        ...
        IB2XTaxYQQuery query = (new TaxYQquery()).getB2XTaxYQQueryImplPort();
        B2XTaxYQ result = query.b2XTaxYQQuery(key, b2XTaxYQ);
