...
public class JsonUtil {
     ...
     * @return 单一值数组
     */
    public static ArrayList<String> getList(String str, ArrayList<String> array) {
        if (!str.contains(",")) {
     ...
     * @return bean对象集合
     */
    public static ArrayList<HashMap<String, Object>> getBeanList(String str, ArrayList<HashMap<String, Object>> list) {
        if (!str.contains("}"))
            return list;
        else {
            ...
            map = getBean(temp1, map);
            list.add(map);
            return getBeanList(temp2, list);
        }
    }
//    public static void main(String[] args){
//    	String str="\"categoryId\":\"1\",\"categoryName\":\"饮品\",\"categoryImage\":\"/upload/yinpin.jpg\"";
//    	HashMap<Object,Object> array = new HashMap<Object,Object>();
//    	JsonUtil.getBean(str, array);
//    	System.out.println(array.get("categoryId"));
//    }
}